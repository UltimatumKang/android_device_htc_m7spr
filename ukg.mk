...
# device
$(call inherit-product-if-exists, device/htc/m7spr/full_m7spr.mk)
...
PRODUCT_BRAND := HTC
PRODUCT_NAME := ukg_m7spr
PRODUCT_MODEL := HTC One
PRODUCT_MANUFACTURER := HTC
PRODUCT_PROPERTY_OVERRIDES += ro.buildzipid=ukg.m7spr.$(shell date +%m%d%y).$(shell date +%H%M%S)
